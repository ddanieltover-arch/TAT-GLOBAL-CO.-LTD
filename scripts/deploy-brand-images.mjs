...
const SITE_JPG = {
  ...
  'packaging-banner.jpg': join(src2, '1 (25).png'),
  'markets-banner.jpg': join(src2, '1 (31).png'),
  'faq-banner.jpg': join(src2, '1 (30).png'),
  'privacy-banner.jpg': join(src2, '1 (34).png'),
  'why-us-quality.jpg': join(src2, '1 (35).png'),
  'home-certifications.jpg': join(src2, '1 (36).png'),
